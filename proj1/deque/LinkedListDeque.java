...
public class LinkedListDeque<T> implements Deque<T>,Iterable<T> {
    ...
    public void addFirst(T x) {
        TNode temp=new TNode(x,sentinel,sentinel.right); //what if sentinel=new? left argument first then error occurs?
        sentinel.right.left=temp;
        sentinel.right=temp;
    ...
    public void addLast(T x) {
        TNode temp=new TNode(x,sentinel.left,sentinel);
        sentinel.left.right=temp;
        sentinel.left=temp;
